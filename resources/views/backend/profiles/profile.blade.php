...
<div class="container-fluid px-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('profile_update') }}" class="text-start mb-3" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <x-common.input :required="true" column=6 type="email" id="email" name="email" label="Email" placeholder="Email" :value="old('email',auth()->user()->email)" readonly></x-common.input>
                            <x-common.file-browse label="Image" :required="false" column=6 name="image" extension="application/image"></x-common.file-browse>
