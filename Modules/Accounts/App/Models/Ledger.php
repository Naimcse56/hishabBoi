...
class Ledger extends Model
{
    ...
    {
        return $this->hasMany(Ledger::class, "parent_id", "id")->with(['categories:id,parent_id,name,code,type,acc_type,is_cost_center,view_in_trial,view_in_bs,view_in_is,level','ledger_balances:id,ledger_id,date,debit,credit','categories.parent:id,name,code','pending_transactions:id,ledger_id,date,type,amount,is_approve']);
    }
