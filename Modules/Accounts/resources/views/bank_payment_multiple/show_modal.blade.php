        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-5 pt-0 pb-0">
                ...
                <div class="row">   
                                   ...
                                   @foreach ($journal->transactions as $item)
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               ...
                                               @endif
                                               @if ($item->narration && $journal->panel == "bank_payment_multiple")
                   ...
                   <div class="col-md-12 d-flex justify-content-between details-voucher-modal-date-section details-voucher-modal-date-section" >
