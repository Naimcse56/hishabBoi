...
@section('content')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between">
            <div><h4 class="mt-4">New Entry Bank Voucher</h4></div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="journal_create_form" method="POST" enctype="multipart/form-data" action="{{route('multi-bank-payment.store')}}">
                            @csrf
                            <div class="row mb-2">
                                    ...
                                    <div class="row new_added_row_cr">                                    
                                        <div class="col-md-8">
                                            <div class="row">
                                                ...
                                                <x-common.server-side-select :required="false" column=4 name="debit_sub_account_id[]" class="credit_sub_account_id" disableOptionText="Select Party Account" label="Party Accounts (Dr)"></x-common.server-side-select>
