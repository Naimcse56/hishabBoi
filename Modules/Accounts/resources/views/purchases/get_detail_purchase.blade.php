...
<div class="row new_added_row">
    ...
    <x-common.input :required="true" type="number" step="0.01" min="0" column=2 name="purchase_price_tax[]" label="Purchase Tax (%)" placeholder="0" :value="$product->purchase_price_tax"></x-common.input>
