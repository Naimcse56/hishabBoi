...
<div class="container-fluid invoice-container">
   ...
   <footer class="text-center mt-4">
     <div class="btn-group btn-group-sm d-print-none"> <a href="{{route('multi-cash-receive.index')}}" class="btn btn-light border text-black-50 shadow-none"><i class="fa fa-list"></i> Back To List</a> </div>
