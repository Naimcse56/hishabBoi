...
@section('content')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between">
            <h4 class="mt-4">W/O Receipt And Payment Report</h4>
            <div>
                <a href="{{route('work-orders.receive_payment_report')}}" class="btn btn-sm btn-primary mt-4 filter_by"><i class="fa fa-refresh"></i></a>
        ...
        <div class="row">
            <div class="col-md-12 filter_div">
                <div class="card">
                    <div class="card-body">
                        <form class="form" method="GET" action="{{route('work-orders.receive_payment_report')}}">
                            <div class="row">
