...
@section('content')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between">
            <h4 class="mt-4">Work Order Profit Loss Report</h4>
            <div>
                <a href="{{route('work-orders.pl_report')}}" class="btn btn-sm btn-primary mt-4 filter_by"><i class="fa fa-refresh"></i></a>
        ...
        <div class="row">
            <div class="col-md-12 filter_div {{isset($filtered_branch) ? 'd-none' : ''}}">
                <div class="card">
                    <div class="card-body">
                        <form class="form" method="GET" action="{{route('work-orders.pl_report')}}">
                            <div class="row">
