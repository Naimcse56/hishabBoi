        ...
        @isset($filtered_branch)
            ...
            @if ($third_section->count() > 0)
                ...
                <tr>
                    ...
                    <td class="text-right nowrap fw-semibold">{{number_format($first_section->sum('prev_amount') - $second_section->sum('prev_amount') - $third_section->sum('prev_amount'),2)}}</td>
                </tr>
            @endif
            @if ($fourth_section->count() > 0)
                ...
                <tr>
                    ...
                    <td class="text-right nowrap fw-semibold">{{number_format($first_section->sum('prev_amount') + $fourth_section->sum('prev_amount') - $second_section->sum('prev_amount') - $third_section->sum('prev_amount'),2)}}</td>
                </tr>
            @endif
            ...
            <tr>
                ...
                <td class="text-right nowrap fw-semibold">{{number_format($first_section->sum('prev_amount') + $fourth_section->sum('prev_amount') - $second_section->sum('prev_amount') - $third_section->sum('prev_amount') - $fifth_section->sum('prev_amount'),2)}}</td>
            </tr>
            ...
            <tr>
                ...
                <td class="text-right nowrap fw-semibold">{{number_format($first_section->sum('prev_amount') + $fourth_section->sum('prev_amount') - $second_section->sum('prev_amount') - $third_section->sum('prev_amount') - $fifth_section->sum('prev_amount') - $tax_section->sum('prev_amount'),2)}}</td>
            </tr>
        @endisset
    </tbody>
