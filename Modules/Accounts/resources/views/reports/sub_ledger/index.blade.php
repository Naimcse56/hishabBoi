...
@section('title')
Party Account Report
@endsection
@section('content')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between">
            <h4 class="mt-4">Party Account Report</h4>
            <div>
                <a href="{{route('accountings.sub_ledger_report')}}" class="btn btn-sm btn-primary mt-4 filter_by"><i class="fa fa-refresh"></i></a>
        ...
        <div class="row">
            <div class="col-md-12 filter_div {{isset($transactions) ? 'd-none' : ''}}">
                <div class="card">
                    <div class="card-body">
                        <form class="form" method="GET" action="{{route('accountings.sub_ledger_report')}}">
                            <div class="row">
                                ...
                                <x-common.server-side-select :required="true" column=4 name="party_id" class="party_id" disableOptionText="Select Party Account" label="Party Accounts (Dr)"></x-common.server-side-select>
