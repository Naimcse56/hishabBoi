    ...
    <tbody>
        @isset($filtered_branch)
            @if ($first_section->count() > 0)
                <tr>
                    <td class="fw-bold" colspan="4" style="text-align: left;">Assets</td>
                </tr>
                @foreach ($first_section->skip(1) as $k => $item)
                    ...
                    <tr>
                        ...
                        <td class="fw-bold">{{$item['children_balance'] != 0 ? $item['code'] : ""}}</td>
                        <td class="text-right nowrap {{$item['children_balance'] != 0 ? 'fw-bold' : ''}}">{{$debit}}</td>
                        <td class="text-right nowrap {{$item['children_balance'] != 0 ? 'fw-bold' : ''}}">{{$credit}}</td>
                    </tr>
                @endforeach
            @endif
            @if ($second_section->count() > 0)
                <tr>
                    <td class="fw-bold" colspan="4" style="text-align: left;">Expenses</td>
                </tr>
            ...
            @if ($third_section->count() > 0)
                <tr>
                    <td class="fw-bold" colspan="4" style="text-align: left;">Liabilities and Equities</td>
                </tr>
            ...
            @if ($fourth_section->count() > 0)
                <tr>
                    <td class="fw-bold" colspan="4" style="text-align: left;">Revenues</td>
                </tr>
