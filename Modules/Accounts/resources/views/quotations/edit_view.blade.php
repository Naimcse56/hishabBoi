                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('quotations.update', encrypt($quotation->id))}}">
                        ...
                        <fieldset class="the-fieldset mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <x-common.input :required="true" type="number" step="1" min="0" column=6 class="total_qty" name="total_qty" label="Total Qty" placeholder="0" :value="$quotation->sale_details()->sum('quantity')"></x-common.input>
