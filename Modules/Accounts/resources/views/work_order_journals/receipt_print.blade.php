...
<div class="row" style="margin-top: 5px;">
    ...
    <div class="col-4" style="font-size: 14px; text-align: center;">
          <p class="mb-0" style="border: 1px solid #000; padding: 5px; border-radius: 100px;">{{strtoupper($journal->TypeDetails)}} (W/O)</p>
    </div>
    <div class="col-4" style="font-size: 14px; text-align: right;">
          <p class="mb-0">JV No : <span style="border-bottom: 1px dotted #000; min-width: 80px; padding: 5px">{{$journal->TypeName}}</span></p>
    </div>
