...
<div class="container-fluid invoice-container">
                   ...
                   <table class="table table-sm mb-0">
                       ...
                       <tbody>
                        @foreach ($journal->transactions as $item)
                           <tr>
                                <td>{{ $item->ledger->name }} ({{ $item->ledger->ac_no ? $item->ledger->ac_no : $item->ledger->code }})</td>
   ...
   <footer class="text-center mt-4">
     <div class="btn-group btn-group-sm d-print-none"> <a href="{{route('journal.work_order.index')}}" class="btn btn-light border text-black-50 shadow-none"><i class="fa fa-list"></i> Back To List</a> </div>
