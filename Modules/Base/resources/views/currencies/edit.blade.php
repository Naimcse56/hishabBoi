    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('currencies.update', encrypt($item->id))}}">
                    @csrf
                    <div class="row">
                        <x-common.input :required="true" column=12 id="name" name="name" label="Name" placeholder="Name" :value="$item->name"></x-common.input>
                        <x-common.input :required="true" column=12 id="code" name="code" label="Currency Code" placeholder="Currency Code" :value="$item->code"></x-common.input>
                        <x-common.input :required="true" column=12 id="symbol" name="symbol" label="Currency Symbol" placeholder="Currency Symbol" :value="$item->symbol"></x-common.input>
